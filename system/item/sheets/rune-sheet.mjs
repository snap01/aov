...
export class AoVRuneSheet extends AoVItemSheet {
  constructor(options = {}) {
    super(options)
  }
  ...
  static PARTS = {
    ...
    details: { template: 'systems/aov/templates/item/rune.detail.hbs' },
  ...
  async _prepareContext(options) {
    ...
    context.effectOptions = await AOVSelectLists.effectOptions()
    return context
  }
